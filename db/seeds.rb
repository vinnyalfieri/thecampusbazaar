...
users = User.create([{name: 'Karlie Kloss', email: 'kkloss@flatironschool.edu', password_digest: "imamodel123"}, 
  {name: 'Vinny Alfieri', email: 'vinnyboy@flatironschool.edu', password_digest: 'newjerseyroxmysox'}, 
  {name: 'MinLing Zhao', email: 'ml@nyu.edu', password_digest: 'projectivespace'}, 
  {name: 'Jake Faris', email: 'farisj@flatironschool.edu', password_digest: 'californiaboy27'}, 
  {name: 'Sara Tibbetts', email: 'sxt4866@rit.edu', password_digest: 'thisisapassword'}, 
  {name: 'Elle Woods', email: 'prettyinpink@harvard.edu', password_digest: 'bruiserwoods'}, 
  {name: 'Ada Lovelace', email: 'a.lovelace@flatironschool.edu', password_digest: 'codeispoetry'}, 
  {name: 'Tommy McGuire', email:'nerdyengineer@rit.edu', password_digest:'eequalsmcsquared'}, 
  {name: 'Emanuel Lori', email: 'e.lori@flatironschool.edu', password_digest: 'iamemanuel'}, 
  {name: 'Avi Flombaum', email: 'avi@flatironschool.edu', password_digest: 'iliketwitter'}, 
  {name: 'George Hotz', email: 'geohot@rit.edu', password_digest: 'ihackthings'}, 
  {name: 'Emma McSeedy', email: 'emma@nyu.edu', password_digest: 'seedsareseedy'}, 
  {name: 'Gloria Winnebago', email: 'gloria@nyu.edu', password_digest: 'inexcelcisdeo'}, 
  {name: 'Dorothy Cohen Schwartz', email: 'dime1@nyu.edu', password_digest: 'dphie'}, 
  {name: 'Ida Beinstalk Landau', email: 'dime2@nyu.edu', password_digest: 'unicorn'}, 
  {name: 'Minna Goldsmith Mahler', email: 'dime3@nyu.edu', password_digest: 'lovelypurpleiris'}, 
  {name: 'Eva Effron Robin', email: 'dime4@nyu.edu', password_digest: 'essequamvidere'}, 
  {name: 'Sylvia Steir Cohn', email: 'dime5@nyu.edu', password_digest: 'ilovepearls'}, 
  {name: 'Sam Feine', email: 'sammyboy@rit.edu', password_digest: 'loud'}, 
  {name: 'Billy Fanelli', email: 'waf6826@rit.edu', password_digest: 'imfromridgewood'}, 
  {name: 'Kristen VonSteuben', email: 'kristen@rit.edu', password_digest: 'toothless'}, 
  {name: 'Mikenzie Kusenberger', email: 'kenzie@rit.edu', password_digest: 'captainamerica'}, 
  {name: 'Will Kommritz', email: 'willy@rit.edu', password_digest: 'kommritzatrit'}, 
  {name: 'Stew Ped', email: 'stewwy@harvard.edu', password_digest: 'imnotstupid'}, 
  {name: 'Laura Wilbar', email: 'laura@harvard.edu', password_digest: 'imsupersmart'}, 
  {name: 'Harry Potter', email: 'harry@harvard.edu', password_digest: 'whyditransfer'}])
